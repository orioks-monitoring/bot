...
def _delete_users_tracking_data_in_notify_settings_off(user_telegram_id: int, user_notify_settings: UserNotifySettings) -> None:
...
async def make_one_user_check(user_telegram_id: int) -> None:
    user_notify_settings = UserHelper.get_user_settings_by_telegram_id(user_telegram_id=user_telegram_id)
