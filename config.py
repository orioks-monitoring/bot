...
class Config:
    ...
    TELEGRAM_STICKER_LOADER = (
        "CAACAgIAAxkBAAEEIlpiLSwO28zurkSJGRj6J9SLBIAHYQACIwADKA9qFCdRJeeMIKQGIwQ"
    )
    ...
    def __init__(self):
        ...
        self.SERVICE_NAME = os.getenv("SERVICE_NAME", "bot")
        self.BASE_DIR = Path(__file__).resolve().parent
        self.LOGS_DIR = self.BASE_DIR / "logs" / self.SERVICE_NAME
        ...
        self.RABBIT_MQ_URL = os.getenv("RABBIT_MQ_URL", "amqp://guest:guest@localhost/")
        self.FERNET_KEY_FOR_COOKIES = bytes(
            os.getenv("FERNET_KEY_FOR_COOKIES", "my32lengthsupersecretnooneknows1"),
            "utf-8",
        )
        ...
        assert "{user_telegram_id}" in self.LOGIN_LOGOUT_SERVICE_URL_FOR_LOGIN, (
        ...
        assert "{user_telegram_id}" in self.LOGIN_LOGOUT_SERVICE_URL_FOR_LOGOUT, (
